...
public class CallLogAdapter extends ArrayAdapter<CallerVO> {

    Context context;
    int resId;
    ArrayList<CallerVO> datas;

    public CallLogAdapter(Context context, int resId, ArrayList<CallerVO> datas) {
        super(context, resId);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final CallerVO vo=datas.get(position);
